...
export function UserItem(props) {
  ...
  const onOpenCloseMoldal = () => setShowModal((prevState) => !prevState);
  ...
  return (
    <>
      ...
      <BasicModal show={showModal} close={onOpenCloseMoldal} title={titleModal}>
        <UserForm close={onOpenCloseMoldal} onReload={onReload} user={user} />
      </BasicModal>
      <Confirm
        open={showConfirm}
